"""
Adds a "service type" (domestic/international) selector with an
auto-suggested shipping cost to the Shipments module inside
app/dashboard/page.tsx.

Run once from the frontend/next-frontend directory:
    python3 scripts/patch_shipments_pricing.py
"""
import shutil
import sys
...
def main():
    ...
    print("Applied: ShipmentsWorkspace pricing update (line-based)")
